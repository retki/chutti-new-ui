...
var ValidatingForm = /** @class */ (function () {
     ...
     *  correct...
     */
    ValidatingForm.prototype.partiallyRevalidate = function () {
        this.form.updateValueAndValidity();
    };
    ValidatingForm.prototype.forceRevalidate = function () {
    ...
    ValidatingForm.prototype.onSubmit = function (form) {
        this.form = form;
        this.forceRevalidate();
        return this.form.valid;
    };
    ValidatingForm.prototype.isFormValid = function () {
        return this.form.valid;
    };
...
var MessageConstant = /** @class */ (function () {
    ...
    MessageConstant.prototype.showNotification = function (message, type) {
        $.notify({
            icon: 'notifications',
            message: message
        }, {
...
var DashboardAttendanceComponent = /** @class */ (function () {
    function DashboardAttendanceComponent(gernericservice, urlconstant, encryptdecryptlocalstorage) {
    ...
    DashboardAttendanceComponent.prototype.ngOnInit = function () {
        this.attendance();
    };
    DashboardAttendanceComponent.prototype.isLate = function (intime, maxtime) {
        var a = intime.split(":");
        var b = maxtime.split(":");
    ...
    DashboardAttendanceComponent.prototype.getTimeByTimeStamp = function (timeStamp) {
        if (timeStamp != null) {
            ...
            var DateValue = date_to_convert.toString().split(' ');
            return DateValue[4];
        }
        else {
            return '--';
    ...
    DashboardAttendanceComponent.prototype.attendance = function () {
        var _this = this;
        ...
        return this.gernericservice.get(this.attendanceUrl + "?gemsEmployeeMasterId=" + this.employeemasterid + "&fromDate=" + this.FromDate + "&toDate=" + this.ToDate).subscribe(function (response) {
            if (response.status.success === 'Fail') {
                _this.totalAttendanceDaysStr = '00';
                _this.totalLateInStatusDaysStr = '00';
            }
            else {
                _this.attendanceList = response.data;
                _this.attendanceListLength = response.data.length;
                for (var i = 0; i < response.data.length; i++) {
                    var inTimeCheckWithDate = response.data[i].attendanceInTime;
                    _this.dateObj = new Date(inTimeCheckWithDate);
                    if (response.data[i].attendanceInTime != null) {
                        if (_this.isLate(_this.getTimeByTimeStamp(response.data[i].attendanceInTime), '09:30:00')) {
                            _this.empLateRequest.push(response.data[i]);
                        }
                    }
                }
                _this.totalAttendanceDays = _this.attendanceListLength == undefined ? 0 : _this.attendanceListLength;
                // this.totalAttendanceDays = this.attendanceListLength;
                if (_this.totalAttendanceDays < 10) {
                    _this.totalAttendanceDaysStr = "0" + _this.totalAttendanceDays;
                }
                else {
                    _this.totalAttendanceDaysStr = _this.totalAttendanceDays + "";
                }
                _this.totalLateInStatusDays = _this.empLateRequest == undefined ? 0 : _this.empLateRequest.length;
                // this.totalLateInStatusDays = this.empLateRequest.length;
                if (_this.totalLateInStatusDays < 10) {
                    _this.totalLateInStatusDaysStr = "0" + _this.totalLateInStatusDays;
                }
                else {
                    _this.totalLateInStatusDaysStr = _this.totalLateInStatusDays + "";
                }
                ;
            }
        });
    };
    return DashboardAttendanceComponent;
}());
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(encryptdecryptlocalstorage, gernericservice, loadingBar, cssservice) {
        this.encryptdecryptlocalstorage = encryptdecryptlocalstorage;
        this.gernericservice = gernericservice;
    ...
    DashboardComponent.prototype.expandleavestatus = function () {
    ...
    //expand and express leave status
    DashboardComponent.prototype.expandwhoseonleave = function () {
    ...
    DashboardComponent.prototype.notification = function () {
        ...
        return this.gernericservice.get(this.notifivationUrl + "?employeeId=" + this.employeeId + "&isNotification=" + this.isNotification).subscribe(function (response) {
            _this.name = response.data.firstName;
...
var LeaveBankComponent = /** @class */ (function () {
    function LeaveBankComponent(urlconstant, genericservice, encryptdecryptlocalstorage, dataSharingService) {
        var _this = this;
        this.urlconstant = urlconstant;
        ...
        this.lop = false;
        this.dataSharingService.appliedFlagObs.subscribe(function (data) {
            console.log('called..........');
            if (data == 'true') {
                console.log('called..........');
                _this.leavebank();
    ...
    LeaveBankComponent.prototype.ngOnInit = function () {
        this.leavebank();
    };
    LeaveBankComponent.prototype.leavebank = function () {
        var _this = this;
        var payloadReqObj = {
            employeeMasterId: this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
            isActive: true
        };
        return this.genericservice.post(this.leaveBankUrl, payloadReqObj, false).subscribe(function (response) {
            _this.leaveBankList = response.data;
            _this.leaveBankList.forEach(function (leaveSummary) {
                leaveSummary.leaveTypeCode == 'SL' ? _this.slCount = leaveSummary.leaveEntitled : null;
                leaveSummary.leaveTypeCode == 'EL' ? _this.elCount = leaveSummary.leaveEntitled : null;
                leaveSummary.leaveTypeCode == 'CL' ? _this.clCount = leaveSummary.leaveEntitled : null;
                leaveSummary.leaveTypeCode == 'SL' ? _this.sllop = leaveSummary.noOfLops : null;
                leaveSummary.leaveTypeCode == 'EL' ? _this.ellop = leaveSummary.noOfLops : null;
                leaveSummary.leaveTypeCode == 'CL' ? _this.cllop = leaveSummary.noOfLops : null;
                leaveSummary.leaveTypeCode == 'PER' ? _this.perlop = leaveSummary.noOfLops : null;
                leaveSummary.leaveTypeCode == 'OD' ? _this.odlop = leaveSummary.noOfLops : null;
                console.log(_this.slCount + " ---" + _this.clCount + "======" + _this.elCount);
                console.log(_this.sllop + " ---" + _this.ellop + "======" + _this.cllop + "======" + _this.perlop + "======" + _this.odlop);
                _this.totallop = _this.sllop + _this.ellop + _this.cllop;
                if (_this.totallop > 1) {
                    _this.lop = true;
                }
                else {
...
var LeaveStatusComponent = /** @class */ (function () {
    function LeaveStatusComponent(urlconstant, genericservice, encryptdecryptlocalstorage, dataSharingService) {
        var _this = this;
        this.urlconstant = urlconstant;
        this.genericservice = genericservice;
        this.encryptdecryptlocalstorage = encryptdecryptlocalstorage;
    ...
    LeaveStatusComponent.prototype.leavestatus = function () {
        var _this = this;
        var payloadReqObj = {
        ...
        return this.genericservice.post(this.leavestatusUrl + "?start=" + this.start + "&limit=" + this.limit + "&status=" + this.status, payloadReqObj, false).subscribe(function (response) {
            if (response.status.success === 'Success') {
                _this.isData = true;
                //this.leavestausList = response.data;
                _this.leavestausList = _this.leaveList(response);
                _this.totalCount = response.totalResult;
                _this.findItemsPerPage();
            }
            else {
                _this.isData = false;
            }
    ...
    LeaveStatusComponent.prototype.leaveList = function (response) {
        var i;
        var list = [];
    ...
    LeaveStatusComponent.prototype.findItemsPerPage = function () {
        this.totalPages = Math.ceil(this.totalCount / this.selectedItemsPerPage);
    };
    LeaveStatusComponent.prototype.goToPageNo = function (event) {
        console.log('on page change');
    };
    LeaveStatusComponent.prototype.goToNext = function (event) {
        var _this = this;
        this.currentPage++;
        var payloadReqObj = {
            "createdBy": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
    ...
    LeaveStatusComponent.prototype.goToPrev = function () {
        var _this = this;
        this.currentPage--;
        var payloadReqObj = {
            "createdBy": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
    ...
    LeaveStatusComponent.prototype.changeItemPerPage = function (event) {
        this.currentPage = 1;
        console.log('event printed' + event);
        this.selectedItemsPerPage = parseInt(event);
        this.refreshList();
    };
    LeaveStatusComponent.prototype.refreshList = function () {
        var _this = this;
        var payloadReqObj = {
            "createdBy": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
            //"reportingTo": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
    ...
    LeaveStatusComponent.prototype.duration = function (responseObject) {
        if (responseObject.leaveTypeCode == "PER") {
            ...
            if (responseObject.permissionDuration.includes('.')) {
                var hour = responseObject.permissionDuration.split('.')[0];
                var minutes = responseObject.permissionDuration.split('.')[1];
                if (hour.length > 0) {
                    if (minutes.length > 0) {
                        if (hour === '0' || hour === 0) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/urlConstant */ "./src/app/services/urlConstant.ts");
/* harmony import */ var _services_ValidatingForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/ValidatingForm */ "./src/app/services/ValidatingForm.ts");





var QuickApplyComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](QuickApplyComponent, _super);
    function QuickApplyComponent(urlconstant, genericservice, commonservice, messageConstant, commonService, encryptdecryptlocalstorage, dataSharingService, calendar) {
        var _this = _super.call(this) || this;
        _this.urlconstant = urlconstant;
        _this.genericservice = genericservice;
        _this.commonservice = commonservice;
        _this.messageConstant = messageConstant;
        _this.commonService = commonService;
        _this.encryptdecryptlocalstorage = encryptdecryptlocalstorage;
        _this.dataSharingService = dataSharingService;
        _this.dashBoardPaginationView = true;
        _this.leaveSummaryList = [];
        _this.leaveSummaryUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].leaveSummaryApi;
        _this.getUserUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getUserAPi;
        _this.getLeaveParamUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getLeaveParamAPi;
        _this.applyLeaveUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].applyLeaveAPi;
        _this.getOrgParmUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getOrgParmApi;
        _this.getLeaveStatusUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getLeaveStatusApi;
        _this.saveNotificationURL = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].saveNotificationApi;
        _this.allEventsUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].allEvents;
        _this.saveEventUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].saveEvent;
        _this.googleSyncUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].googleSyncUrl;
        _this.getHolidaysUrl = _services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].holidayList;
        _this.gemsEmployeeMasterObj = null;
        _this.halfdayflog = true;
        _this.type = 'LEA';
        _this.lveParamDetails = null;
        _this.orgParamDetails = null;
        _this.employeeLeaveMaster = [];
        _this.employeeMaster = [];
        _this.leaveSummaryWithODPERList = [];
        _this.data2 = null;
        _this.dataSource1 = [];
        _this.hoursflog = true;
        _this.meridian = true;
        _this.spinners = false;
        _this.permissionDate = 'DATE';
        _this.startTimepickerAM = true;
        _this.startTimepickerPM = false;
        _this.endTimepickerAM = false;
        _this.endTimepickerPM = true;
        _this.options1 = {
            locale: {
                format: 'DD MMM YYYY',
                'applyLabel': 'Done',
        ...
        _this.leaveTypeChecked = false;
        //ON DUTY
        _this.onDutyChecked = true;
        _this.onDutyEndAMorPM = 'AM';
        _this.onDutyStartAMorPM = 'AM';
        _this.isChecked = true;
        _this.leaveDisable = true;
        _this.preloader = false;
        _this.isLoadingResults = false;
        _this.messageStore = messageConstant;
        _this.isActive = true;
        _this.timeFlag = false;
        _this.isLop = true;
        _this.NON_WORKINGDAYS_LEAVE_ERROR_MESSAGE = messageConstant.NON_WORKINGDAYS_LEAVE_ERROR_MESSAGE;
        _this.APPLY_LEAVE_ERROR = messageConstant.APPLY_LEAVE_ERROR;
        _this.NO_REPORTING_MANAGER = messageConstant.NO_REPORTING_MANAGER;
        _this.APPLY_PERMISSION = messageConstant.APPLY_PERMISSION;
        _this.APPLY_PERMISSION_ERROR = messageConstant.APPLY_PERMISSION_ERROR;
        _this.APPLY_ONDUTY = messageConstant.APPLY_ONDUTY;
        _this.APPLY_ONDUTY_ERROR = messageConstant.APPLY_ONDUTY_ERROR;
        _this.permissionStartTimepicker = { hour: 9, minute: 30, second: 0 };
        _this.permissionEndTimepicker = { hour: 10, minute: 0, second: 0 };
        _this.fromDate = calendar.getToday();
        _this.fromDateOnDuty = calendar.getToday();
        _this.today = calendar.getToday();
        _this.toDate = calendar.getNext(calendar.getToday(), 'd', 10);
        _this.toDateOnDuty = calendar.getNext(calendar.getToday(), 'd', 10);
        _this.dataSharingService.appliedFlagObs.subscribe(function (data) {
            console.log('called..........');
            if (data == 'true') {
                console.log('called..........');
                _this.fromDate = calendar.getToday();
                _this.today = calendar.getToday();
                _this.isRange(_this.fromDate);
                _this.getEmployeeByUserId();
            }
        });
        return _this;
    }
    QuickApplyComponent.prototype.ngOnInit = function () {
        ...
        this.getHolidays();
        this.timeFlag = false;
        this.leaveTypesControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]);
    };
    QuickApplyComponent.prototype.getHolidays = function () {
        var _this = this;
        var reqPayload = {
            "gemsOrganisation": {
        ...
        this.genericservice.post(this.getHolidaysUrl, reqPayload, false).subscribe(function (res) {
            // this.preloader = false;
            _this.holidayList = res.data;
        });
    };
    //daterangepicker methods
    QuickApplyComponent.prototype.onDateSelection = function (date) {
        this.halfLeaveType = '';
    ...
    QuickApplyComponent.prototype.isHovered = function (date) {
        return this.fromDate && !this.toDate && this.hoveredDate && date.after(this.fromDate) && date.before(this.hoveredDate);
    };
    QuickApplyComponent.prototype.isInside = function (date) {
        return date.after(this.fromDate) && date.before(this.toDate);
    };
    QuickApplyComponent.prototype.isRange = function (date) {
        return date.equals(this.fromDate) || date.equals(this.toDate) || this.isInside(date) || this.isHovered(date);
    };
    QuickApplyComponent.prototype.onSelectedDate = function (e) {
    ...
    QuickApplyComponent.prototype.setValues = function () {
        this.quickLeaveForm.controls['daterange'].setValue(this.startLeaveDate + "-" + this.EndLeaveDate);
    };
    QuickApplyComponent.prototype.resetFormInDatePicker = function () {
    ...
    QuickApplyComponent.prototype.onDutyDateSelection = function (date) {
    ...
    QuickApplyComponent.prototype.isOnDutyHovered = function (date) {
    ...
    QuickApplyComponent.prototype.setOnDutyValues = function () {
        if (this.inTime == null || this.outTime == null || this.inTime == undefined || this.outTime == undefined) {
            ...
            var timeForOnDuty = '(' + this.inTime.hour + ':' + this.inTime.minute + this.onDutyStartAMorPM + '-'
    ...
    QuickApplyComponent.prototype.resetOnDutyDatePicker = function () {
    ...
    //daterangepicker ends
    QuickApplyComponent.prototype.goToConfirmLop = function (leaveForm) {
    };
    QuickApplyComponent.prototype.ngAfterViewInit = function () {
        var obj = { target: { 'value': 'LEA' } };
    ...
    QuickApplyComponent.prototype.radioChange = function (event) {
        if (event != undefined) {
    ...
    QuickApplyComponent.prototype.startTimepickerAMOrPM = function (event) {
        if (event === 'AM') {
            $('#am').addClass('active');
    ...
    QuickApplyComponent.prototype.endTimepickerAMorPM = function (event) {
        if (event === 'AM') {
    ...
    QuickApplyComponent.prototype.resetPermissionForm = function () {
        this.startTimepickerAM = true;
        this.endTimepickerPM = true;
    ...
    QuickApplyComponent.prototype.reset = function () {
        this.quickPermisstionForm.reset();
    };
    QuickApplyComponent.prototype.getEmployeeByUserId = function () {
        var _this = this;
        this.leaveSummaryList = [];
        console.log(this.encryptdecryptlocalstorage.getLocalStorage('employeeId'));
        var employeeSummaryViewObj = {
            "employeeMasterId": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
        ...
        this.genericservice.post(this.leaveSummaryUrl, employeeSummaryViewObj, false)
            .subscribe(function (leaveSummaryListData) {
            console.log(leaveSummaryListData.data);
            var leavetypeList = [];
            _this.leaveSummaryWithODPERList = leaveSummaryListData.data;
            leavetypeList = leaveSummaryListData.data;
            _this.leaveSummaryList = [];
            leavetypeList.forEach(function (leaveSummary) {
                if (leaveSummary !== null && (leaveSummary.leaveTypeCode !== 'OD'
                    && leaveSummary.leaveTypeCode !== 'PER')) {
                    _this.leaveSummaryList.push(leaveSummary);
                }
            });
        });
    };
    QuickApplyComponent.prototype.createQuickLeaveForm = function () {
        this.quickLeaveForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            daterange: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            leaveType: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            reason: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, validSpace]),
        });
        this.quickPermisstionForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            onPerDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            reason: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, validSpace]),
        });
        this.quicOnDutyForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            onDutyDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            reason: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, validSpace]),
            inTimeControl: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](),
            outTimeControl: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]()
        });
    };
    QuickApplyComponent.prototype.getUserObj = function () {
        var _this = this;
        var userObj = {
        ...
        this.genericservice.post(this.getUserUrl, userObj, false)
            ...
            _this.gemsEmployeeMasterObj = userdata.data;
            _this.encryptdecryptlocalstorage.setToLocalStorage('reportingManagerId', _this.gemsEmployeeMasterObj.currentReportingTo.gemsEmployeeMasterId);
        });
    };
    QuickApplyComponent.prototype.getLeaveParam = function () {
        var _this = this;
        this.preloader = true;
        ...
        this.genericservice.post(this.getLeaveParamUrl, paramOgj, false).subscribe(function (response) {
            if (response != null) {
                _this.lveParamDetails = response.data;
                _this.availableperHour = response.gemsMaxPerHour;
                _this.max = _this.availableperHour;
                _this.elAvailableAfter = response.effectiveAfter;
            }
        });
        this.preloader = false;
    };
    QuickApplyComponent.prototype.getOrganisationParam = function () {
        var _this = this;
        var paramOgj = {
            'gemsOrganisation': {
                'gemsOrgId': this.encryptdecryptlocalstorage.getLocalStorage('organizationId'),
        ...
        return this.genericservice.post(this.getOrgParmUrl, paramOgj, false).subscribe(function (response) {
            _this.orgParamDetails = response.data;
        });
    };
    QuickApplyComponent.prototype.ForHalfdayFun = function (e) {
    ...
    QuickApplyComponent.prototype.onPermissionDate = function (e) {
        var date = e.year + '-' + e.month + '-' + e.day;
        this.permissionDate = this.formatDate(date);
        this.quickPermisstionForm.controls['onPerDate'].setValue(this.permissionDate);
    };
    QuickApplyComponent.prototype.setPermissionValues = function () {
    ...
    QuickApplyComponent.prototype.formatDate = function (paramdate) {
    ...
    QuickApplyComponent.prototype.formatDate2 = function (paramdate1) {
    ...
    QuickApplyComponent.prototype.halfdaychkfun = function (event) {
    ...
    QuickApplyComponent.prototype.onDutyHoursfun = function (event) {
        this.inTime = null;
        this.outTime = null;
        var input = event.target.checked;
        if (input === true) {
    ...
    QuickApplyComponent.prototype.onDutyHalfdaychkfun = function (event) {
        var FDate = new Date(event.start);
        var SecDate = new Date(event.end);
        var FDateconcot = FDate.getFullYear() + "-" + (FDate.getMonth() + 1) + "-" + FDate.getDate();
        var SecDateconcot = SecDate.getFullYear() + "-" + (SecDate.getMonth() + 1) + "-" + SecDate.getDate();
    ...
    //OnDuty AM or PM
    QuickApplyComponent.prototype.onDutyStartAMOrPM = function (event) {
        if (event === 'AM') {
    ...
    QuickApplyComponent.prototype.onDutyEndAMOrPM = function (event) {
        if (event === 'AM') {
    ...
    QuickApplyComponent.prototype.getWorkingDays = function (totaldays, fromDate, toDate) {
        var count = totaldays;
        ...
        for (var i = 1; i <= totaldays; i++) {
            ...
            if (this.lveParamDetails.isHoliday) {
                for (var k = 0; k < this.holidayList.length; k++) {
                    var holiday = new Date(this.holidayList[k].gemsHolidayOn + ' 00:00:00');
    ...
    QuickApplyComponent.prototype.getLeaveStatus = function (gemsEmployeeMasterObj) {
        var _this = this;
        this.preloader = true;
        this.isLoadingResults = true;
        this.dataSource1 = [];
        ...
        this.isActive = true;
        var employeeLeaveMasterViewObj = {
            "createdBy": this.gemsEmployeeMasterId,
            "organisationId": JSON.parse(localStorage.gemsOrganisation).gemsOrgId
        };
        return this.genericservice.post(this.getLeaveStatusUrl, employeeLeaveMasterViewObj, false).subscribe(function (leaveHeaderListdata) {
            _this.preloader = false;
            _this.isLoadingResults = false;
            //this.LeaveList = leaveHeaderListdata;
            _this.data2 = leaveHeaderListdata.data;
            //this.tableData1.dataRows = leaveHeaderListdata.data; // Assigning Json response to Json Array
            _this.data2.length > 0 ? _this.noRecentLeaveRecordsFound = false : _this.noRecentLeaveRecordsFound = true;
            _this.dataSource1 = _this.data2;
    ...
    QuickApplyComponent.prototype.getNextDateByTime = function (time) {
        var date = new Date(time);
        var d = date.getDate() + 1;
        var dateFormate = date.getFullYear() + "-" + (date.getMonth() + 1) + '-' + d;
        return dateFormate;
    };
    QuickApplyComponent.prototype.getDifferenceOfDays = function (fromDate, toDate) {
        fromDate = this.getCorrectDate(fromDate);
        toDate = this.getCorrectDate(toDate);
        if (this.empLeaveEntitled < 1 && this.leaveTypeChecked) {
            return 0.5;
        }
        var day1 = new Date(fromDate).getTime();
        var day2 = new Date(toDate).getTime();
        var timeDiff = day2 - day1;
        var dayDiff = timeDiff / 1000 / 60 / 60 / 24;
        return ((dayDiff) + 1);
    };
    QuickApplyComponent.prototype.getCorrectDate = function (datee) {
        var date = datee.split('-');
        var year = date[0];
        var month = date[1].length == 1 ? '0' + date[1] : date[1];
        var day = date[2].length == 1 ? '0' + date[2] : date[2];
        return year + "-" + month + "-" + day;
    };
    QuickApplyComponent.prototype.getDifferenceOfDays1 = function (fromDate, toDate) {
        fromDate = this.getCorrectDate(fromDate);
        toDate = this.getCorrectDate(toDate);
    ...
    QuickApplyComponent.prototype.showNotification = function (message, type) {
        this.messageConstant.showNotification(message, type);
    };
    QuickApplyComponent.prototype.showSuccessNotification = function (message) {
        $.notify({
            icon: 'notifications',
            message: message
        }, {
    ...
    QuickApplyComponent.prototype.applyLeave = function () {
        this.quickLeaveForm.value.leaveTypesControl = this.leaveTypesControl.value.leaveTypeDescription;
    };
    QuickApplyComponent.prototype.submitLeaveForm = function (LeaveForm) {
        var _this = this;
        ...
        var todate1;
        // this.quickLeaveForm.value.leaveTypesControl = this.leaveTypesControl.value.leaveTypeDescription;
        if (_super.prototype.onSubmit.call(this, this.quickLeaveForm)) {
            if (this.validLeaveType === undefined) {
                ...
                this.leaveSummaryList.forEach(function (leaveSummary) {
                    //console.log(leaveSummary.gemsLeaveTypeMaster.leaveTypeDescription);
                    if (leaveSummary !== null && leaveSummary.leaveTypeDescription ===
                        _this.quickLeaveForm.value.leaveType.leaveTypeDescription) {
                        _this.empLeaveSummaryObj = leaveSummary;
                    }
                });
                var leaveSummaryObject = {
                ...
                console.log(Object_1.permissionDuration);
                console.log(this.getWorkingDays(Math.abs(this.getDifferenceOfDays(SDateValue, EDateValue)), SDateValue, EDateValue));
                if (Object_1.permissionDuration == 0 || this.getWorkingDays(Math.abs(this.getDifferenceOfDays(SDateValue, EDateValue)), SDateValue, EDateValue) == 0) {
                ...
                // localStorage.setItem('LeaveObject',Object);
                    ...
                    var days = this.getWorkingDays(Math.abs(this.getDifferenceOfDays(SDateValue, EDateValue)), SDateValue, EDateValue);
                    if ((this.empLeaveSummaryObj.leaveEntitled) - days >= 0 || Object_1.isAfternoonLeave || Object_1.isForenoonLeave) {
                        this.preloader = true;
                        this.isLoadingResults = true;
                        this.genericservice.post(this.applyLeaveUrl, Object_1, true).subscribe(function (response) {
                            _this.halfLeaveType = '';
                            _this.leaveDisable = true;
                            if (response.data.gemsEmployeeLeaveMasterId != null) {
                                _this.employeeLeaveMaster = response.data;
                                _this.dataSharingService.trigegerApplyFlag('true');
                                // Save Notification
                                var reqPayload = {
                                    "notification": response.data.notification,
                                    "gemsEmployeeMasterId": _this.encryptdecryptlocalstorage.getLocalStorage('reportingManagerId')
                                };
                                _this.genericservice.post(_this.saveNotificationURL, reqPayload, false).subscribe(function (res) {
                                });
                                ...
                                _this.preloader = false;
                                var event_1 = {
                                    'end': { 'date': _this.commonService.getToByTime(response.data.toDate) },
                                    'start': { 'date': _this.commonService.getDateByTime(response.data.fromDate) },
                                    'summary': response.data.leaveCode + ' - ' + response.data.status,
                                    'description': response.data.reason
                                };
                                _this.genericservice.saveCalendarEvents(_this.googleSyncUrl, event_1).subscribe(function (data) {
                                    console.log('called inside of save event');
                                    var eventId = _this.saveEventId(data);
                                    var eventObj = {
                                        'gemsEmployeeLeaveMaster': _this.employeeLeaveMaster,
                                        'eventId': eventId,
                                        'flag': 1,
                                        'createdBy': +_this.encryptdecryptlocalstorage.getLocalStorage('employeeId')
                                    };
                                    _this.genericservice.post(_this.saveEventUrl, eventObj, false).subscribe(function (data) {
                                    });
                                }, function (error) {
                                    var eventObj = {
                                        'gemsEmployeeLeaveMaster': _this.employeeLeaveMaster,
                                ...
                                console.log("In 591");
                                _this.dataSharingService.failureMessage(response.data.remarks);
                            ...
                            // this.ngOnInit();
                            _this.type = 'LEA';
                            _this.halfdayflog = false;
                            _this.leaveTypeChecked = false;
                            _this.noonFlag = false;
                            _this.isLoadingResults = false;
                            _this.preloader = false;
                            // this.myNgForm.resetForm();
                            _this.leaveTypesControl.reset();
                            _this.leaveDisable = true;
                        }, function (error) {
                            if (error.message == 'REPORTING MANAGER NOT FOUND') {
                                ...
                                _this.dataSharingService.failureMessage(_this.NO_REPORTING_MANAGER);
                                _this.preloader = false;
                            }
                            else {
                                //this.quickLeaveForm.reset();
                                ...
                                _this.dataSharingService.failureMessage(_this.APPLY_LEAVE_ERROR);
                                _this.preloader = false;
                            }
                            // this.ngOnInit();
                            _this.type = 'LEA';
                        ...
                        var nooflops = days - this.empLeaveSummaryObj.leaveEntitled;
                        if (this.halfdayflog === true) {
                            if (this.noonFlag == true) {
                                nooflops = 0.5;
                            }
                        }
                        Object_1.noOfLops = nooflops;
                        this.lopObject = Object_1;
    ...
    QuickApplyComponent.prototype.confirmLeaveRequest = function () {
        var _this = this;
        this.genericservice.post(this.applyLeaveUrl, this.lopObject, true).subscribe(function (response) {
            _this.quickLeaveForm.reset();
            _this.resetFormInDatePicker();
            _this.dataSharingService.trigegerApplyFlag('true');
            // Save Notification
            var reqPayload = {
                "notification": response.data.notification,
    ...
    QuickApplyComponent.prototype.applyPermission = function (quickPermisstionForm) {
        var _this = this;
        var e_1, _a;
        this.preloader = true;
        var isValidPermission = true;
        ...
        if (_super.prototype.onSubmit.call(this, this.quickPermisstionForm)) {
            ...
            try {
                ...
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.leaveSummaryWithODPERList), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var leaveSummary = _c.value;
                    if (leaveSummary !== null && leaveSummary.leaveTypeCode === 'PER') {
                        ...
                        if (new Date(formdate1) > new Date(todate1)) {
                            ...
                            if (this.getWorkingDays(Math.abs(this.getDifferenceOfDays(SDateValue, EDateValue)), SDateValue, EDateValue) == 0) {
                                ...
                                this.preloader = true;
                                this.isLoadingResults = true;
                                var maxduration = this.timeDiff(SDate, EDate).split('.')[0];
                                var maxMinutes = this.timeDiff(SDate, EDate).split('.')[1];
                                ...
                                this.genericservice.post(this.applyLeaveUrl, Object2, true).subscribe(function (response) {
                                    ...
                                    if (response.data.gemsEmployeeLeaveMasterId != null) {
                                        ...
                                        _this.genericservice.saveCalendarEvents(_this.googleSyncUrl, event_2).subscribe(function (data) {
                                            console.log('called inside of save event');
                                            var eventId = _this.saveEventId(data);
                                            var eventObj = {
                                                'gemsEmployeeLeaveMaster': _this.employeeLeaveMaster,
                                    ...
                                    if (error.message === 'REPORTING MANAGER NOT FOUND') {
                                        ...
                                        _this.dataSharingService.failureMessage(_this.APPLY_PERMISSION_ERROR);
                                    }
                                    //  this.myNgForm.resetForm();
                                    _this.preloader = false;
                                    _this.isLoadingResults = false;
    ...
    QuickApplyComponent.prototype.checkLeaveType = function () {
    ...
    QuickApplyComponent.prototype.onKeyPress = function (event) {
        var pattern = /[0-9]/;
    ...
    QuickApplyComponent.prototype.onTimeChange = function (event, className) {
        var condition1 = event > 12 && (className == '.endHour' || className == '.startHour');
        var condition2 = event > 59 && (className == '.endMinute' || className == '.startMinute');
    ...
    QuickApplyComponent.prototype.applyOnDuty = function () {
        var _this = this;
        this.preloader = true;
        if (_super.prototype.onSubmit.call(this, this.quicOnDutyForm)) {
            ...
            this.leaveSummaryWithODPERList.forEach(function (leaveSummary) {
                if (leaveSummary !== null && leaveSummary.leaveTypeCode === 'OD') {
                    _this.empLeaveSummaryObj = leaveSummary;
                    var leaveSummaryObject = {
                        "gemsEmployeeLeaveSummaryId": leaveSummary.employeeLeaveSummayMasterId,
                    ...
                    if (_this.inTime != null) {
                        if (_this.onDutyStartAMorPM == 'AM') {
                            if (_this.inTime.hour == '12') {
                                _this.inTime.hour = 0;
                            }
                            else {
                                _this.inTime.hour = parseInt(_this.inTime.hour);
                            }
                        }
                        else if (_this.onDutyStartAMorPM == 'PM') {
                            if (_this.inTime.hour == '12') {
                                _this.inTime.hour = parseInt(_this.inTime.hour);
                            }
                            else {
                                _this.inTime.hour = parseInt(_this.inTime.hour) + 12;
                            }
                        }
                        SDate.setHours(_this.inTime.hour);
                        SDate.setMinutes(_this.inTime.minute);
                    }
                    if (_this.outTime != null) {
                        if (_this.onDutyEndAMorPM == 'AM') {
                            if (_this.outTime.hour == 12 || _this.outTime.hour == '12') {
                                _this.outTime.hour = 0;
                            }
                            else {
                                _this.outTime.hour = parseInt(_this.outTime.hour);
                            }
                        }
                        else if (_this.onDutyEndAMorPM == 'PM') {
                            if (_this.outTime.hour == 12 || _this.outTime.hour == '12') {
                                _this.outTime.hour = parseInt(_this.outTime.hour);
                            }
                            else {
                                _this.outTime.hour = parseInt(_this.outTime.hour) + 12;
                            }
                        }
                        EDate.setHours(_this.outTime.hour);
                        EDate.setMinutes(_this.outTime.minute);
                    }
                    var formdate1 = void 0;
                    var todate1 = void 0;
                    var isFullDay = false;
                    if (_this.timeFlag == null || _this.timeFlag == false) {
                        formdate1 = SDateValue + ' ' + '09' + ':' + '30' + ':' + '00';
                        todate1 = EDateValue + ' ' + '18' + ':' + '30' + ':' + '00';
                        isFullDay = true;
                    }
                    else if (_this.timeFlag) {
                        // let flag = false;
                        if (_this.inTime != null || _this.inTime != undefined) {
                            formdate1 = SDateValue + ' ' + _this.inTime.hour + ':' + _this.inTime.minute + ':' + '00';
                        }
                        else {
                            //  this.quicOnDutyForm.controls['inTimeControl'].setErrors({ 'required': true });
                            // flag = true;
                        }
                        if (_this.outTime != null || _this.outTime != undefined) {
                            todate1 = EDateValue + ' ' + _this.outTime.hour + ':' + _this.outTime.minute + ':' + '00';
                        }
                        else {
                            //  this.quicOnDutyForm.controls['outTimeControl'].setErrors({ 'required': true });
                            // flag = true;
                        }
                        if (_this.inTime.hour >= _this.outTime.hour) {
                            if (_this.inTime.minute >= _this.outTime.minute) {
                                // alert(SDate.getHours() >= EDate.getHours())
                                //  alert("FAIL");
                                _this.inValidOutTime = true;
                                //  this.quicOnDutyForm.controls['outTimeControl'].setErrors({ 'incorrect': true });
                                // flag = true;
                            }
                            else {
                                // alert("FAIL 11");
                                _this.inValidOutTime = false;
                    ...
                    var Object_2 = {
                        ...
                        "reason": _this.quicOnDutyForm.value.reason,
                        // "permissionDuration": Math.abs(this.getDifferenceOfDays(SDateValue, SDateValue)),
                        "permissionDuration": (_this.inTime != null && _this.outTime != null) ? _this.timeDiff(SDate, EDate) : Math.abs(_this.getDifferenceOfDays1(SDateValue, EDateValue)),
                        "isActive": true,
                        "status": "PENDING",
                        "createdBy": _this.gemsEmployeeMasterObj,
                        "gemsEmplyeeLeaveSummary": leaveSummaryObject,
                        "createdOn": new Date(),
                        "updatedOn": new Date(),
                    ...
                    _this.timeFlag = false;
                    _this.genericservice.post(_this.applyLeaveUrl, Object_2, true).subscribe(function (response) {
                        ...
                        if (response.data.gemsEmployeeLeaveMasterId != null) {
                            ...
                            _this.genericservice.saveCalendarEvents(_this.googleSyncUrl, event_3).subscribe(function (data) {
                                console.log('called inside of save event');
                                var eventId = _this.saveEventId(data);
                                var eventObj = {
                                    'gemsEmployeeLeaveMaster': _this.employeeLeaveMaster,
                        ...
                        if (error.message === 'REPORTING MANAGER NOT FOUND') {
                            ...
                            _this.quicOnDutyForm.reset();
                            _this.resetOnDutyDatePicker();
                            _this.dataSharingService.failureMessage(_this.APPLY_ONDUTY_ERROR);
                            // alert(this.APPLY_ONDUTY_ERROR);
                        }
                        // this.myNgForm.resetForm();
                        // this.hoursflog = false;
    ...
    QuickApplyComponent.prototype.timeDiff = function (EDate, SDate) {
        // start = start.split(":");
        // end = end.split(":");
    ...
    QuickApplyComponent.prototype.halfdayRadioChange = function (event) {
        this.halfLeaveType = event.target.value;
    };
    QuickApplyComponent.prototype.isValidLeaveTypeControl = function (event) {
    ...
    QuickApplyComponent.prototype.removeclass = function () {
        $(function () {
    ...
    QuickApplyComponent.prototype.saveEventId = function (data) {
        // let EventCode = JSON.parse(data._body).htmlLink.split("eid=")[1]
        var EventCode = data.htmlLink.split("eid=")[1];
        var Event = this.commonservice.base64ToString(EventCode);
        var eventId = Event[0];
        return eventId;
    };
    return QuickApplyComponent;
}(_services_ValidatingForm__WEBPACK_IMPORTED_MODULE_4__["ValidatingForm"]));
...
var WhosOnLeaveComponent = /** @class */ (function () {
    function WhosOnLeaveComponent(urlconstant, genericservice, encryptdecryptlocalstorage, daterangepickerOptions, datepipe, calendar, cssservice) {
        var _this = this;
        this.urlconstant = urlconstant;
        this.genericservice = genericservice;
        this.encryptdecryptlocalstorage = encryptdecryptlocalstorage;
        ...
        this.cssservice.isExpandFlagObs.subscribe(function (data) {
            console.log('css notification');
            _this.showdashwhoseonleavepagination = data;
            if (data == true) {
                console.log('css notification trigger.....');
                if ($('.nav-item.active.test').length == 0) { }
                else {
                    console.log('css notification trigger.....');
                    _this.expandwhoseonleave(true);
                    $('.nav-item.active').removeClass('test');
                }
            }
        });
    }
    WhosOnLeaveComponent.prototype.ngOnInit = function () {
        this.whoisonLeave();
        this.leavestatus();
        // this.diffBtwDays();
        this.showHide = false;
    ...
    WhosOnLeaveComponent.prototype.onDateSelection = function (date) {
        if (!this.fromDate && !this.toDate) {
            this.fromDate = date;
            this.finalDateFrom = this.fromDate.year + '-' + this.fromDate.month + '-' + this.fromDate.day;
        }
    ...
    WhosOnLeaveComponent.prototype.isHovered = function (date) {
        return this.fromDate && !this.toDate && this.hoveredDate && date.after(this.fromDate) && date.before(this.hoveredDate);
    };
    WhosOnLeaveComponent.prototype.isInside = function (date) {
        return date.after(this.fromDate) && date.before(this.toDate);
    };
    WhosOnLeaveComponent.prototype.isRange = function (date) {
        return date.equals(this.fromDate) || date.equals(this.toDate) || this.isInside(date) || this.isHovered(date);
    };
    WhosOnLeaveComponent.prototype.onSelectedDate = function (e) {
        var date = e.year + '-' + e.month + '-' + e.day;
    };
    WhosOnLeaveComponent.prototype.setValues = function () {
        this.showHide = false;
        this.selectedItemsPerPage = 10;
        this.calendarApplied(this.finalDateFrom, this.finalDateTo);
    };
    WhosOnLeaveComponent.prototype.resetFormInDatePicker = function () {
        this.fromDate = this.today;
        this.toDate = this.today;
        this.finalDateFrom = this.fromDate.year + '-' + this.fromDate.month + '-' + this.fromDate.day;
        this.finalDateTo = this.toDate.year + '-' + this.toDate.month + '-' + this.toDate.day;
    ...
    WhosOnLeaveComponent.prototype.formatDate = function (paramdate) {
        var date = new Date(paramdate);
        var months = ['JAN', 'FEB', 'MAR', 'APR', 'MAY',
            'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC'];
        var day = date.getDate();
    ...
    //DaterangePicker ends
    WhosOnLeaveComponent.prototype.selectedDate = function (value, datepicker) {
    ...
    WhosOnLeaveComponent.prototype.whoisonLeave = function () {
        var _this = this;
        var payloadReqObj = {
            transactionType: "LEA",
            status: "APPROVED",
        ...
        this.genericservice.post(this.whoIsOnUrl, payloadReqObj, false).subscribe(function (response) {
            if (response.status.success === 'Success') {
                _this.isData = true;
                _this.whoisonLeaveList = response.data;
                _this.nextOfNextWeekList = _this.modifiedList(response.data.nextOfNextWeek);
                _this.nextWeekList = _this.modifiedList(response.data.nextWeek);
                _this.todayList = _this.modifiedList(response.data.today);
                _this.thisweekList = _this.modifiedList(response.data.thisWeek);
                _this.nextOfNextWeekStartDate = _this.whoisonLeaveList.nextOfNextWeekDateRange.split('to')[0].trim();
                _this.nextOfNextWeekEndDate = _this.whoisonLeaveList.nextOfNextWeekDateRange.split('to')[1].trim();
            }
            else {
                _this.isData = false;
            }
    ...
    //Today Filter
    WhosOnLeaveComponent.prototype.leavestatus = function () {
        var _this = this;
        this.selectedItemsPerPage = 10;
        ...
        this.fromdate = "";
        this.todate = "";
        return this.genericservice.post(this.whoISonLeaveExpansionURL + "?fromDate=" + this.fromdate + '&toDate=' + this.todate + "&start=" + this.start + '&limit=' + this.limit, payloadReqObj, false).subscribe(function (response) {
            if (response.status.success === 'Fail') {
                _this.isData = false;
            }
            else {
                _this.isData = true;
                _this.leavestausList = _this.updateList(response);
                _this.totalCount = response.totalResult;
                _this.findItemsPerPage();
            }
        }, function (error) {
    ...
    WhosOnLeaveComponent.prototype.findItemsPerPage = function () {
        this.totalPages = Math.ceil(this.totalCount / this.selectedItemsPerPage);
    };
    WhosOnLeaveComponent.prototype.goToPageNo = function (event) {
        console.log('on page change');
    };
    WhosOnLeaveComponent.prototype.goToNext = function () {
        this.currentPage++;
        this.start = this.start + this.limit;
        this.limit = this.selectedItemsPerPage;
        this.refreshPagination();
    };
    WhosOnLeaveComponent.prototype.goToPrev = function () {
        this.currentPage--;
        this.start = this.start - this.limit;
        this.limit = this.selectedItemsPerPage;
        this.refreshPagination();
    };
    WhosOnLeaveComponent.prototype.changeItemPerPage = function (event) {
        console.log('event printed' + event);
    ...
    WhosOnLeaveComponent.prototype.refreshList = function () {
        var _this = this;
        var payloadReqObj = {
            transactionType: "LEA",
            status: "APPROVED",
    ...
    WhosOnLeaveComponent.prototype.calendarCanceled = function (e) {
        console.log(e);
        // e.event
        // e.picker
    };
    WhosOnLeaveComponent.prototype.calendarApplied = function (fromdate, todate) {
        var _this = this;
    ...
    // month started
    WhosOnLeaveComponent.prototype.monthclick = function () {
        this.selectedItemsPerPage = 10;
    ...
    WhosOnLeaveComponent.prototype.nextmonths = function () {
        console.log(this.currentMonth);
        this.currentPage = 1;
        this.addMonth();
    };
    WhosOnLeaveComponent.prototype.addMonth = function () {
        var _this = this;
        ...
        var formattedMonth = this.monthsList[firstDay.getMonth()];
        ...
        this.start = 0;
        this.limit = this.selectedItemsPerPage;
        return this.genericservice.post(this.whoISonLeaveExpansionURL + "?fromDate=" + this.firstDays + '&toDate=' + this.lastDays + "&start=" + this.start + '&limit=' + this.limit, payloadReqObj, false).subscribe(function (response) {
            if (response.status.success === 'Fail') {
                _this.isData = false;
            }
            else {
    ...
    WhosOnLeaveComponent.prototype.decreaseMonth = function () {
        var _this = this;
        this.currentPage = 1;
        this.index--;
    ...
    WhosOnLeaveComponent.prototype.week = function () {
        this.showHide = false;
        this.selectedItemsPerPage = 10;
    };
    //View More Referesh List
    WhosOnLeaveComponent.prototype.expansionRefresh = function () {
        // const payloadReqObj = {
        //   transactionType: 'LEA',
        //   status: 'APPROVED',
        //   organisationId: this.encryptdecryptlocalstorage.getLocalStorage('organizationId'),
    ...
    WhosOnLeaveComponent.prototype.viewMoreDetails = function (type) {
        this.showHide = false;
    ...
    WhosOnLeaveComponent.prototype.expandwhoseonleave = function (expand) {
    ...
    WhosOnLeaveComponent.prototype.onexpand = function () {
        this.expandwhoseonleave(false);
        // $('.filterToday').toggleClass('active');
        this.leavestatus();
    };
    WhosOnLeaveComponent.prototype.diffBtwDays = function (start, end) {
        start = '2019-08-01';
        end = '2019-08-31';
    ...
    //Refresh Pagination
    WhosOnLeaveComponent.prototype.refreshPagination = function () {
        var _this = this;
        var payloadReqObj = {
            transactionType: 'LEA',
            status: 'APPROVED',
        ...
        return this.genericservice.post(this.whoISonLeaveExpansionURL + '?fromDate=' + this.fromdate +
            '&toDate=' + this.todate + '&start=' + this.start + '&limit=' + this.limit, payloadReqObj, false).subscribe(function (response) {
            if (response.status.success === 'Fail') {
                _this.isData = false;
            }
            else {
    ...
    WhosOnLeaveComponent.prototype.updateList = function (response) {
        var i;
        var list = [];
        for (i = 0; i < response.data.length; i++) {
            var responseObj = response.data[i];
    ...
    WhosOnLeaveComponent.prototype.modifiedList = function (response) {
        var i;
        var list = [];
    ...
    WhosOnLeaveComponent.prototype.duration = function (responseObject) {
        if (responseObject.leaveTypeCode == "PER") {
            responseObject.permissionDuration = responseObject.permissionDuration.toString();
            if (responseObject.permissionDuration.includes('.')) {
                var hour = responseObject.permissionDuration.split('.')[0];
...
//# sourceMappingURL=default~dashboard-dashboard-module-ngfactory~leave-leave-module-ngfactory-es5.js.map