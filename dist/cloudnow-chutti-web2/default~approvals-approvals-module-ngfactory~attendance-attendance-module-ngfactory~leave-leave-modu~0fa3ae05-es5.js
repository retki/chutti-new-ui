...
var EmployeeLateRequest = /** @class */ (function () {
    function EmployeeLateRequest() {
    }
    return EmployeeLateRequest;
}());
...
var ApprovalsRoutingModule = /** @class */ (function () {
    function ApprovalsRoutingModule() {
    }
...
var AttendanceapprovalsComponent = /** @class */ (function () {
    function AttendanceapprovalsComponent(genericservice, encryptdecryptlocalstorage) {
    ...
    AttendanceapprovalsComponent.prototype.ngOnInit = function () {
        this.PreLoader = true;
        this.todayDate = new Date();
        var currentmonth = this.todayDate.getMonth();
        ...
        this.temp = new Date();
        var year = this.temp.getFullYear();
        this.pastYears = (this.temp.getFullYear() - 10);
        for (var i = this.pastYears; i <= year; i++) {
            this.years.push(i);
        }
        this.years.reverse();
        this.getEmployee();
    ...
    AttendanceapprovalsComponent.prototype.getEmployee = function () {
        var _this = this;
        var userObj = {
            "gemsUserMasterId": this.encryptdecryptlocalstorage.getLocalStorage('userId')
        };
        return this.genericservice.post(this.getEmployeeDetailUrl, userObj, false).subscribe(function (employeedata) {
            _this.gemsEmployeeMaster = employeedata.data;
        });
    };
    AttendanceapprovalsComponent.prototype.addreasonClicked = function (attendanceData) {
        this.attendanceObj = attendanceData;
        this.addreasonform.reset();
    };
    AttendanceapprovalsComponent.prototype.addReasonForLate = function () {
        var _this = this;
        ...
        this.genericservice.post(this.saveLateRequestUrl, this.gemsEmployeeLateRequest, false).subscribe(function (lateRequestData) {
            _this.attendanceDetails.cntEmployeeLateRequest = lateRequestData.data;
            _this.attendanceDetails.attendanceDate = _this.attendanceObj.attendanceDate;
            _this.attendanceDetails.gemsEmployeeMaster = _this.gemsEmployeeMaster;
            _this.attendanceDetails.cntAttendanceDetailId = _this.attendanceObj.cntAttendanceDetailId;
            _this.attendanceDetails.attendanceInTime = _this.attendanceObj.attendanceInTime;
            _this.attendanceDetails.attendanceOutTime = _this.attendanceObj.attendanceOutTime;
            _this.genericservice.post(_this.saveAttendanceUrl, _this.attendanceDetails, false).subscribe(function (attendanceMaster) {
                _this.saveAttendance = attendanceMaster.data;
                _this.getAttendanceByMonth();
            });
        });
    };
    AttendanceapprovalsComponent.prototype.getAttendanceByMonth = function () {
        var _this = this;
        this.PreLoader = true;
        var attendancemonth = this.selectedmonth.value;
        var attendanceyear = this.selectedyear;
        ...
        return this.genericservice.post(this.attendanceApprovalListUrl + '?start=' + this.start + '&limit=' + this.limit, attendanceViewObj, false).subscribe(function (response) {
            if (response.status.success === 'Success') {
                _this.isData1 = true;
                _this.attendancerecords = response.data;
                _this.totalCount1 = response.totalResult;
    ...
    AttendanceapprovalsComponent.prototype.goToNext = function () {
        var _this = this;
        this.currentPage++;
        this.PreLoader = true;
        var attendancemonth = this.selectedmonth.value;
        ...
        this.limit = this.selectedItemsPerPage;
        this.genericservice.post(this.attendanceApprovalListUrl + '?start=' + this.start + '&limit=' + this.limit, attendanceViewObj, false).subscribe(function (response) {
            if (response.status.success === 'Success') {
                _this.isData1 = true;
                _this.attendancerecords = response.data;
                _this.totalCount1 = response.totalResult;
    ...
    AttendanceapprovalsComponent.prototype.goToPrev = function () {
        var _this = this;
        this.currentPage--;
        this.PreLoader = true;
        var attendancemonth = this.selectedmonth.value;
    ...
    AttendanceapprovalsComponent.prototype.isLate = function (intime, maxtime) {
        var a = intime.split(":");
        if (maxtime == null) {
            maxtime = '09:30:00';
        }
    ...
    AttendanceapprovalsComponent.prototype.getTimeByTimeStampWithReturn = function (timeStamp) {
        if (timeStamp != null) {
    ...
    AttendanceapprovalsComponent.prototype.getDateByTime = function (time) {
        var date = new Date(time);
        var month = date.getMonth() + 1;
        var dateFormate = date.getFullYear() + "-" + month + "-" + date.getDate();
        return dateFormate;
    };
    AttendanceapprovalsComponent.prototype.getTimeByTimeStamp = function (timeStamp) {
        if (timeStamp != null) {
            var date_to_convert = new Date(timeStamp);
            var local_date = new Date();
            date_to_convert.setMinutes(date_to_convert.getMinutes() + local_date.getTimezoneOffset());
    ...
    AttendanceapprovalsComponent.prototype.getOrganisationWeekOff = function (attendance) {
        var attendanceDate = new Date(attendance.attendanceDate);
    ...
    AttendanceapprovalsComponent.prototype.getToDate = function (month, year) {
    ...
    AttendanceapprovalsComponent.prototype.getDuration = function (duration) {
    ...
    AttendanceapprovalsComponent.prototype.changeItemPerPage = function (event) {
        console.log('event printed' + event);
        this.selectedItemsPerPage = event;
        this.getAttendanceByMonth();
        this.refreshList();
    };
    AttendanceapprovalsComponent.prototype.findItemsPerPage = function () {
        this.totalPages = Math.ceil(this.totalCount1 / +this.selectedItemsPerPage);
    };
    AttendanceapprovalsComponent.prototype.refreshList = function () {
        var _this = this;
        this.PreLoader = true;
        var attendancemonth = this.selectedmonth.value;
        var attendanceyear = this.selectedyear;
    ...
    AttendanceapprovalsComponent.prototype.actionOnRequest = function (actionName, attendanceData) {
        var _this = this;
        var lateRequestObj = attendanceData.cntEmployeeLateRequest;
        ...
        this.genericservice.post(this.saveLateRequestUrl, lateRequestObj, true).subscribe(function (response) {
            console.log("Late Request Saved");
            _this.attendanceDetails.cntEmployeeLateRequest = response.data;
            _this.attendanceDetails.attendanceDate = attendanceData.attendanceDate;
            _this.attendanceDetails.gemsEmployeeMaster = _this.gemsEmployeeMaster;
            _this.attendanceDetails.cntAttendanceDetailId = attendanceData.cntAttendanceDetailId;
            _this.attendanceDetails.attendanceInTime = attendanceData.attendanceInTime;
            _this.attendanceDetails.attendanceOutTime = attendanceData.attendanceOutTime;
            _this.genericservice.post(_this.saveAttendanceUrl, _this.attendanceDetails, false).subscribe(function (attendanceMaster) {
                _this.saveAttendance = attendanceMaster.data;
                _this.getAttendanceByMonth();
            });
    ...
    return AttendanceapprovalsComponent;
}());
...
var LeaveDetailsComponent = /** @class */ (function () {
    function LeaveDetailsComponent(router, activatedRoute, genericservice, encryptdecryptlocalstorage) {
        this.router = router;
    ...
    LeaveDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            _this.empleaveRequestToken = params['leavetoken'];
        });
        debugger;
        if (this.empleaveRequestToken === undefined || this.empleaveRequestToken === null || this.empleaveRequestToken === '') {
            ...
            this.genericservice.post(this.leaverequestUrl, leaveObj, false).subscribe(function (response) {
                if (response.data) {
                    _this.employeeLeaveMasterResponse = response.data;
                    _this.emailRejection = true;
                    _this.profileImage = _this.employeeLeaveMasterResponse.profileImage;
                    var employeeObj = {
                        "gemsEmployeeMasterId": _this.employeeLeaveMasterResponse.createdBy.gemsEmployeeMasterId
                    };
                    _this.genericservice.post(_this.leaveSummariesUrl, employeeObj, false).subscribe(function (leaveSummaryListData) {
                        _this.leaveSummaryWithODPERList = leaveSummaryListData.data;
                        _this.leaveSummaryWithODPERList.forEach(function (leaveSummary) {
                ...
                _this.router.navigateByUrl('user/approvals/leaveapprovals');
    ...
    LeaveDetailsComponent.prototype.getLeaveObjectById = function () {
        var _this = this;
        this.emailRejection = false;
        var empLeaveObj = {
            "gemsEmployeeLeaveMasterId": this.empleaveRequestId
        };
        this.genericservice.post(this.leaverequestUrl, empLeaveObj, false).subscribe(function (response) {
            _this.employeeLeaveMasterResponse = response.data;
            //
            _this.profileImage = _this.employeeLeaveMasterResponse.profileImage;
            var employeeObj = {
    ...
    //Apporove the leave
    LeaveDetailsComponent.prototype.approveLeaveRequest = function (gemsLeaveObj) {
        var _this = this;
        ...
        this.genericservice.post(this.applyLeaveUrl, this.EmployeeLeaveHistory, false).subscribe(function (LeaveStatusData) {
            _this.router.navigateByUrl('user/approvals/leaveapprovals');
        });
    };
    // Hold the leave
    LeaveDetailsComponent.prototype.holdLeaveRequest = function (gemsLeaveObj) {
        var _this = this;
    ...
    // Reject the  Leave
    LeaveDetailsComponent.prototype.rejectLeaveRequest = function (gemsLeaveObj) {
        var _this = this;
    ...
    LeaveDetailsComponent.prototype.pendingHoldLeave = function (gemsLeaveRequest) {
    ...
    LeaveDetailsComponent.prototype.approvedLeaveReject = function (gemsLeaveRequest) {
        var fromDate = new Date(gemsLeaveRequest.fromDate);
        var fromDateValue = fromDate.getFullYear() + "-" + (fromDate.getMonth() + 1) + "-" + fromDate.getDate();
    ...
    LeaveDetailsComponent.prototype.approveRejectLeaveReason = function (gemsLeaveRequest) {
        var fromDate = new Date(gemsLeaveRequest.fromDate);
        var fromDateValue = fromDate.getFullYear() + "-" + (fromDate.getMonth() + 1) + "-" + fromDate.getDate();
    ...
    LeaveDetailsComponent.prototype.rejectinvalid = function () {
        this.leaveDetailForm.invalid;
    };
    LeaveDetailsComponent.prototype.onKeyPress = function (event) {
...
var LeaveapprovalsComponent = /** @class */ (function () {
    function LeaveapprovalsComponent(router, urlconstant, genericservice, route, encryptdecryptlocalstorage, loadingBar, dataSharingService, commonService) {
        var _this = this;
        this.router = router;
        ...
        this.dataSharingService.appliedFlagObs.subscribe(function (data) {
            ...
            if (data == 'true') {
                console.log('called..........');
                _this.leaveapprovals();
            }
        });
    }
    LeaveapprovalsComponent.prototype.ngOnInit = function () {
        this.createForm();
        this.leaveapprovals();
    };
    LeaveapprovalsComponent.prototype.createForm = function () {
    ...
    LeaveapprovalsComponent.prototype.leaveapprovals = function () {
        var _this = this;
        var payload = {
            "gemsUserMasterId": this.encryptdecryptlocalstorage.getLocalStorage('userId'),
        };
        this.genericservice.post(this.getuserUrl, payload, false).subscribe(function (response) {
            _this.employeeId = response.data.gemsEmployeeMasterId;
            var payloadReqObj = {
                "reportingTo": _this.employeeId,
            };
            _this.start = 0;
            _this.limit = _this.selectedItemsPerPage;
            return _this.genericservice.post(_this.leavestatusUrl + "?start=" + _this.start + "&limit=" + _this.limit + "&status=" + _this.status, payloadReqObj, false).subscribe(function (response) {
                if (response.status.success === 'Success') {
                    _this.isData = true;
    ...
    LeaveapprovalsComponent.prototype.viewLeavePage = function (leaveObj) {
        localStorage.setItem('LeaveId', leaveObj.gemsEmployeeLeaveMasterId + '');
        this.router.navigateByUrl('user/approvals/leavedetails');
    };
    LeaveapprovalsComponent.prototype.approvedLeaveReject = function (gemsLeaveRequest) {
        var fromDate = new Date(gemsLeaveRequest.fromDate);
        var fromDateValue = fromDate.getFullYear() + "-" + (fromDate.getMonth() + 1) + "-" + fromDate.getDate();
        if (gemsLeaveRequest.status == 'APPROVED' && (new Date(fromDateValue) > new Date())) {
            return true;
    ...
    //leave approved
    LeaveapprovalsComponent.prototype.leaverequest = function (leavestatusobj) {
        var _this = this;
        this.preloader = true;
        var payloadReqObj = {
            "gemsEmployeeLeaveMasterId": leavestatusobj.gemsEmployeeLeaveMasterId
        };
        this.genericservice.post(this.leaverequestUrl, payloadReqObj, false).subscribe(function (response) {
            _this.rejectionform.reset();
            console.log(response);
            leavestatusobj = response.data;
            leavestatusobj.status = "APPROVED";
            leavestatusobj.isFlag = true;
            leavestatusobj.updatedBy = _this.gemsEmployeeMasterId;
            // this.employeeleaveHistory.updatedOn = new Date();
            _this.employeeleaveHistory = leavestatusobj;
            _this.genericservice.post(_this.applyLeaveUrl, _this.employeeleaveHistory, true).subscribe(function (response) {
                // 
                console.log(response);
                _this.leaveapprovals();
                // Save Notification
    ...
    //leave rejected
    LeaveapprovalsComponent.prototype.leaverejected = function (leavestatusobj) {
        var _this = this;
        this.preloader = true;
        var payloadReqObj = {
            "gemsEmployeeLeaveMasterId": leavestatusobj.gemsEmployeeLeaveMasterId,
        ...
        this.genericservice.post(this.leaverequestUrl, payloadReqObj, false).subscribe(function (response) {
            ...
            leavestatusobj.isFlag = true;
            leavestatusobj.updatedBy = _this.gemsEmployeeMasterId;
            leavestatusobj.remarks = _this.rejectionform.value.reason;
            // this.employeeleaveHistory.updatedOn = new Date();
            _this.employeeleaveHistory = leavestatusobj;
            _this.genericservice.post(_this.applyLeaveUrl, _this.employeeleaveHistory, true).subscribe(function (response) {
                console.log(response);
    ...
    LeaveapprovalsComponent.prototype.reject = function (leavestatusobj) {
        this.rejectionform.reset();
        console.log(leavestatusobj);
        this.leaveObject = leavestatusobj;
    };
    //leave onhold
    LeaveapprovalsComponent.prototype.leaveonhold = function (leavestatusobj) {
        var _this = this;
        this.preloader = true;
        var payloadReqObj = {
            "gemsEmployeeLeaveMasterId": leavestatusobj.gemsEmployeeLeaveMasterId
    ...
    LeaveapprovalsComponent.prototype.leaveList = function (response) {
        var i;
        var list = [];
    ...
    LeaveapprovalsComponent.prototype.findItemsPerPage = function () {
        this.totalPages = Math.ceil(this.totalCount / this.selectedItemsPerPage);
    };
    LeaveapprovalsComponent.prototype.goToPageNo = function (event) {
        console.log('on page change');
    };
    LeaveapprovalsComponent.prototype.goToNext = function (event) {
        var _this = this;
        this.currentPage++;
        var payloadReqObj = {
    ...
    LeaveapprovalsComponent.prototype.goToPrev = function () {
        var _this = this;
        this.currentPage--;
        var payloadReqObj = {
            "reportingTo": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
    ...
    LeaveapprovalsComponent.prototype.changeItemPerPage = function (event) {
        this.currentPage = 1;
        console.log('event printed' + event);
        this.selectedItemsPerPage = parseInt(event);
        this.refreshList();
    };
    LeaveapprovalsComponent.prototype.refreshList = function () {
        var _this = this;
        var payloadReqObj = {
            "reportingTo": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
        };
    ...
    LeaveapprovalsComponent.prototype.duration = function (responseObject) {
    ...
    LeaveapprovalsComponent.prototype.close = function () {
        this.rejectionform.reset();
        // this.rejectionform.value.reason = "";
    };
    ;
    LeaveapprovalsComponent.prototype.getEventId = function (res) {
        var _this = this;
        console.log("before call service");
        this.genericservice.get(this.eventIdUrl + "/" + res.data.gemsEmployeeLeaveMasterId).subscribe(function (response) {
            if (res.status.success == 'Success') {
                console.log(" service Success");
                var event_1 = {
                    'end': { 'date': _this.commonService.getToByTime(res.data.toDate) },
                    'start': { 'date': _this.commonService.getDateByTime(res.data.fromDate) },
                    'summary': res.data.leaveCode + ' - ' + res.data.status,
                    'description': res.data.reason
                };
                var eventId = response.data.eventId;
                _this.genericservice.updateCalendarEvents(_this.googleSyncUrlapi + eventId, event_1).subscribe(function (response) {
    ...
    return LeaveapprovalsComponent;
}());
...
//# sourceMappingURL=default~approvals-approvals-module-ngfactory~attendance-attendance-module-ngfactory~leave-leave-modu~0fa3ae05-es5.js.map