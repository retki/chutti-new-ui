...
var AttendanceLeave = /** @class */ (function () {
...
var TimeSheetWrapper = /** @class */ (function () {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var src_app_services_urlConstant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/urlConstant */ "./src/app/services/urlConstant.ts");
...
/* harmony import */ var src_app_model_attendanceDetail_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/model/attendanceDetail.model */ "./src/app/model/attendanceDetail.model.ts");
/* harmony import */ var src_app_model_timesheet_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/model/timesheet.model */ "./src/app/model/timesheet.model.ts");
/* harmony import */ var src_app_model_timeSheetWrapper_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/model/timeSheetWrapper.model */ "./src/app/model/timeSheetWrapper.model.ts");
...
var AddTimeSheetComponent = /** @class */ (function () {
    function AddTimeSheetComponent(router, activatedRoute, genericservice, encryptdecryptlocalstorage) {
        var _this = this;
        this.router = router;
        ...
        this.mask = [/\d/, /\d/, ':', /\d/, /\d/];
        this.getProjectListApi = src_app_services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getProjectApi;
        this.getAttendanceLeaveApi = src_app_services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getAttendanceLeaveApi;
        this.saveTimeSheetApi = src_app_services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].saveTimeSheetApi;
        this.getEmployeeApi = src_app_services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getEmployeeApi;
        this.weekdurationList = [];
        this.listofWeekDays = [];
        this.attendanceLeave = new src_app_model_attendanceDetail_model__WEBPACK_IMPORTED_MODULE_5__["AttendanceLeave"]();
        this.weeklist = [false, false, false, false, false, false, false];
        this.weeklyTimeSheet = new src_app_model_timesheet_model__WEBPACK_IMPORTED_MODULE_6__["TimeSheet"]();
        this.weekdayList = [];
        this.timeSheetWrapper = new src_app_model_timeSheetWrapper_model__WEBPACK_IMPORTED_MODULE_7__["TimeSheetWrapper"]();
        this.getTimeSheetById = src_app_services_urlConstant__WEBPACK_IMPORTED_MODULE_3__["UrlConstant"].getTimeSheetApi;
        this.activatedRoute.queryParams.subscribe(function (params) {
            if (params['gemsEmployeeTimeSheetId'] !== null && params['gemsEmployeeTimeSheetId'] !== undefined) {
                _this.gemsTimeSheetDetailId = params['gemsEmployeeTimeSheetId'];
                console.log(_this.gemsTimeSheetDetailId);
            }
        });
    }
    AddTimeSheetComponent.prototype.ngOnInit = function () {
        ...
        if (this.gemsTimeSheetDetailId == undefined || this.gemsTimeSheetDetailId == null) {
            ...
            this.genericservice.post(this.getTimeSheetById, payload, '').subscribe(function (response) {
                if (response.data != null) {
                    var timesheetdetail = response.data;
                    // this.timeSheetId = this.editGemsProjectMaster.gemsEmployeeTimeSheetId;
                    _this.timeSheetWrapper = timesheetdetail;
                    ...
                    var date = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheet.weekDuration.split(' ');
                    var date1 = date[0].split('/');
                    var date2 = date[2].split('/');
                    var formdate = date1[2] + '/' + date1[1] + '/' + date1[0];
                    var todate = date2[2] + '/' + date2[1] + '/' + date2[0];
                    _this.monValue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[1].hours + '';
                    _this.tueValue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[2].hours + '';
                    _this.wedValue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[3].hours + '';
                    _this.thuValue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[4].hours + '';
                    _this.friValue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[5].hours + '';
                    _this.satValue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[6].hours + '';
                    _this.sunValue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[0].hours + '';
                    _this.monvalue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[1].hours + '';
                    _this.tuevalue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[2].hours + '';
                    _this.wedvalue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[3].hours + '';
                    _this.thuvalue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[4].hours + '';
                    ...
                    _this.satvalue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[6].hours + '';
                    _this.sunvalue = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[0].hours + '';
                    _this.sum = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheet.totalHours;
                    _this.timeSheetLineId = [];
                    for (var id = 0; id < 7; id++) {
                        _this.timeSheetLineId.push(_this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheetLine[id].gemsEmployeeWeeklyTimeSheetLineId);
                    }
                    _this.timeSheetLineId.sort();
                    _this.getAssignedProjectList();
                    _this.fromdate = new Date(formdate);
                    _this.todate = new Date(todate);
                    _this.getWeekDurationList();
                    _this.getAttendanceByWeek(_this.fromdate, _this.todate);
                    _this.selectedproject = _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheet.gemsProjectMaster;
                }
            });
        }
    };
    AddTimeSheetComponent.prototype.getEmployeedetails = function () {
        var _this = this;
        var payload = {
            "gemsUserMasterId": this.encryptdecryptlocalstorage.getLocalStorage('userId')
        };
        this.genericservice.post(this.getEmployeeApi, payload, '').subscribe(function (response) {
            _this.employeeDetails = response.data;
        });
    };
    AddTimeSheetComponent.prototype.getAttendanceByWeek = function (fromdate, todate) {
        var _this = this;
        ...
        this.fieldfri = true;
        this.fieldsat = true;
        var starDate = this.getDateStringformDate(fromdate);
        var endDate = this.getDateStringformDate(todate);
        this.listofWeekDays = this.getDateArray(new Date(starDate), new Date(endDate));
        var gemsEmployeeMasterId = this.encryptdecryptlocalstorage.getLocalStorage('employeeId');
        ...
        this.genericservice.post(this.getAttendanceLeaveApi + '?start=0&limit=0&attendanceType=0', this.attendanceLeave, '').subscribe(function (attendanceMaster) {
            if (attendanceMaster.data != null) {
                _this.attendanceMasterlist = attendanceMaster.data;
                for (var i = 0; i < _this.attendanceMasterlist.length; i++) {
                    if (_this.attendanceMasterlist[i].attendanceInTime == null && _this.attendanceMasterlist[i].attendanceOutTime == null) {
                        if (_this.attendanceMasterlist[i].leaveCode != 'OnDuty') {
                            if (_this.listofWeekDays[0].getDate() === new Date(_this.attendanceMasterlist[i].attendanceDate).getDate()) {
                                _this.weeklist[0] = true;
                                _this.leavecodesun = _this.attendanceMasterlist[i].leaveCode;
                            }
                            else {
                                _this.isSunday = false;
                            }
                            if (_this.listofWeekDays[1].getDate() === new Date(_this.attendanceMasterlist[i].attendanceDate).getDate()) {
                                _this.weeklist[1] = true;
                                _this.leavecodemon = _this.attendanceMasterlist[i].leaveCode;
                            }
                            else {
                                _this.isMonday = false;
                            }
                            if (_this.listofWeekDays[2].getDate() === new Date(_this.attendanceMasterlist[i].attendanceDate).getDate()) {
                                _this.weeklist[2] = true;
                                _this.leavecodetue = _this.attendanceMasterlist[i].leaveCode;
                            }
                            else {
                                _this.isTuesday = false;
                            }
                            if (_this.listofWeekDays[3].getDate() === new Date(_this.attendanceMasterlist[i].attendanceDate).getDate()) {
                                _this.weeklist[3] = true;
                                _this.leavecodewed = _this.attendanceMasterlist[i].leaveCode;
                            }
                            else {
                                _this.isWednesday = false;
                            }
                            if (_this.listofWeekDays[4].getDate() === new Date(_this.attendanceMasterlist[i].attendanceDate).getDate()) {
                                _this.weeklist[4] = true;
                                _this.leavecodethu = _this.attendanceMasterlist[i].leaveCode;
                            }
                            else {
                                _this.isThrusday = false;
                            }
                            if (_this.listofWeekDays[5].getDate() === new Date(_this.attendanceMasterlist[i].attendanceDate).getDate()) {
                                _this.weeklist[5] = true;
                                _this.leavecodefri = _this.attendanceMasterlist[i].leaveCode;
                            }
                            else {
                                _this.isFirday = false;
                            }
                            if (_this.listofWeekDays[6].getDate() === new Date(_this.attendanceMasterlist[i].attendanceDate).getDate()) {
                                _this.weeklist[6] = true;
                                _this.leavecodesat = _this.attendanceMasterlist[i].leaveCode;
                            }
                            else {
                                _this.isSaturday = false;
                            }
                        }
                    }
                    else {
                        if (_this.attendanceMasterlist[i].durationBtwInOut != '') {
                            switch (new Date(_this.attendanceMasterlist[i].attendanceDate).getDay()) {
                                case 0:
                                    _this.sunDuration = _this.attendanceMasterlist[i].durationBtwInOut;
                                    break;
                                case 1:
                                    _this.monDuration = _this.attendanceMasterlist[i].durationBtwInOut;
                                    break;
                                case 2:
                                    _this.tueDuration = _this.attendanceMasterlist[i].durationBtwInOut;
                                    break;
                                case 3:
                                    _this.wedDuration = _this.attendanceMasterlist[i].durationBtwInOut;
                                    break;
                                case 4:
                                    _this.thuDuration = _this.attendanceMasterlist[i].durationBtwInOut;
                                    break;
                                case 5:
                                    _this.friDuration = _this.attendanceMasterlist[i].durationBtwInOut;
                                    break;
                                case 6:
                                    _this.satDuration = _this.attendanceMasterlist[i].durationBtwInOut;
                                    break;
                            }
                        }
                    }
            ...
            (_this.listofWeekDays[0].getDate() >= todaydate.getDate()) && (_this.listofWeekDays[0].getMonth() + 1 == todaydate.getMonth() + 1) || (_this.listofWeekDays[0].getMonth() + 1 > todaydate.getMonth() + 1)
                ? _this.weeklist[0] = true : _this.isSunday = false;
            (_this.listofWeekDays[1].getDate() >= todaydate.getDate()) && (_this.listofWeekDays[1].getMonth() + 1 == todaydate.getMonth() + 1) || (_this.listofWeekDays[1].getMonth() + 1 > todaydate.getMonth() + 1)
                ? _this.weeklist[1] = true : _this.isMonday = false;
            (_this.listofWeekDays[2].getDate() >= todaydate.getDate()) && (_this.listofWeekDays[2].getMonth() + 1 == todaydate.getMonth() + 1) || (_this.listofWeekDays[2].getMonth() + 1 > todaydate.getMonth() + 1)
                ? _this.weeklist[2] = true : _this.isTuesday = false;
            (_this.listofWeekDays[3].getDate() >= todaydate.getDate()) && (_this.listofWeekDays[3].getMonth() + 1 == todaydate.getMonth() + 1) || (_this.listofWeekDays[3].getMonth() + 1 > todaydate.getMonth() + 1)
                ? _this.weeklist[3] = true : _this.isWednesday = false;
            (_this.listofWeekDays[4].getDate() >= todaydate.getDate()) && (_this.listofWeekDays[4].getMonth() + 1 == todaydate.getMonth() + 1) || (_this.listofWeekDays[4].getMonth() + 1 > todaydate.getMonth() + 1)
                ? _this.weeklist[4] = true : _this.isThrusday = false;
            (_this.listofWeekDays[5].getDate() >= todaydate.getDate()) && (_this.listofWeekDays[5].getMonth() + 1 == todaydate.getMonth() + 1) || (_this.listofWeekDays[5].getMonth() + 1 > todaydate.getMonth() + 1)
                ? _this.weeklist[5] = true : _this.isFirday = false;
            (_this.listofWeekDays[6].getDate() >= todaydate.getDate()) && (_this.listofWeekDays[6].getMonth() + 1 == todaydate.getMonth() + 1) || (_this.listofWeekDays[6].getMonth() + 1 > todaydate.getMonth() + 1)
                ? _this.weeklist[6] = true : _this.isSaturday = false;
        });
    };
    AddTimeSheetComponent.prototype.getAttendanceByWeekDetails = function () {
        var weekduration = this.selectedweek.split('-');
        var fDate = weekduration[0].split('/');
        var eDate = weekduration[1].split('/');
    ...
    AddTimeSheetComponent.prototype.getDateStringformDate = function (date) {
        var month = date.getMonth() + 1;
        return date.getFullYear() + '-' + month + '-' + date.getDate();
    };
    AddTimeSheetComponent.prototype.getDateArray = function (start, end) {
        var arr = new Array();
    ...
    AddTimeSheetComponent.prototype.getFromDate = function () {
        var date = new Date();
        ...
        switch (this.today.getDay()) {
            case 0:
                ...
                return this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(new Date(date), 0);
            // break;
            case 1:
                day = 'Monday';
                //console.log('date in switch: ' + this.today.getDate());
                return this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(new Date(date), -1);
            //  break;
            case 2:
                day = 'Tuesday';
                return this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(new Date(date), -2);
            // break;
            case 3:
                day = 'Wednesday';
                return this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(new Date(date), -3);
            //  break;
            case 4:
                day = 'Thursday';
                return this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(new Date(date), -4);
            //  break;
            case 5:
                day = 'Friday';
                return this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(new Date(date), -5);
            //  break;
            case 6:
                day = 'Saturday';
                return this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(new Date(date), -6);
        }
    };
    AddTimeSheetComponent.prototype.getTodate = function (fromdate) {
        return this.todate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(this.fromdate, 6);
    };
    AddTimeSheetComponent.prototype.getFormatedDate = function (date) {
    ...
    AddTimeSheetComponent.prototype.getWeekDurationList = function () {
        var week = this.getFormatedDate(this.fromdate) + ' - ' + this.getFormatedDate(this.todate);
        this.selectedweek = week;
        for (var i = 0; i < 5; i++) {
            this.weekdurationList.push(week);
            this.fromdate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(this.fromdate, -7);
            this.todate = Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["addDays"])(this.fromdate, 6);
    ...
    AddTimeSheetComponent.prototype.getAssignedProjectList = function () {
        var _this = this;
        var payLoad = {
            "gemsEmployeeMaster": {
        ...
        return this.genericservice.post(this.getProjectListApi, payLoad, '').subscribe(function (response) {
            var e_1, _a;
            _this.projectList = response.data;
            if (_this.gemsTimeSheetDetailId != null && _this.gemsTimeSheetDetailId != undefined) {
                try {
                    for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](_this.projectList), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var project = _c.value;
                        if (project.gemsProjectMaster.gemsProjectMasterId == _this.timeSheetWrapper.gemsEmployeeWeeklyTimeSheet.gemsProjectMaster.gemsProjectMasterId) {
                            _this.selectedproject = project.gemsProjectMaster;
                        }
                    }
                }
                ...
                _this.selectedproject = _this.projectList != null ? _this.projectList[0].gemsProjectMaster : null;
            }
        });
    };
    AddTimeSheetComponent.prototype.formChanges = function () {
        var _this = this;
        this.newtimesheet = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({});
        this.newtimesheet.valueChanges.subscribe(function (value) {
            _this.add(1);
        });
    };
    AddTimeSheetComponent.prototype.add = function (e) {
        ...
        var SVALUE = this.getTimeTotal(this.sunValue, this.monValue);
        var FValue = this.getTimeTotal(SVALUE, this.tueValue);
        var SecValue = this.getTimeTotal(FValue, this.wedValue);
        var threeValue = this.getTimeTotal(SecValue, this.thuValue);
        var fourValue = this.getTimeTotal(threeValue, this.friValue);
        var LastValue = this.getTimeTotal(fourValue, this.satValue);
        //alert(LastValue);
        this.sum = LastValue;
        var sumValue = LastValue.split(':');
    ...
    AddTimeSheetComponent.prototype.getTimeTotal = function (time1, time2) {
        var time1_hr;
        var time1_min;
        var time2_hr;
        var time2_min;
    ...
    AddTimeSheetComponent.prototype.onSearchsun = function (e) {
        var sun;
    ...
    AddTimeSheetComponent.prototype.onSearchmon = function (e) {
        var mon;
        if (e.srcElement != undefined) {
    ...
    AddTimeSheetComponent.prototype.onSearchtue = function (e) {
        var tue;
        if (e.srcElement != undefined) {
    ...
    AddTimeSheetComponent.prototype.onSearchwed = function (e) {
        var wed;
        if (e.srcElement != undefined) {
    ...
    AddTimeSheetComponent.prototype.onSearchthu = function (e) {
        var thu;
        if (e.srcElement != undefined) {
    ...
    AddTimeSheetComponent.prototype.onSearchfri = function (e) {
        var fri;
        if (e.srcElement != undefined) {
    ...
    AddTimeSheetComponent.prototype.onSearchsat = function (e) {
        var sat;
        if (e.srcElement != undefined) {
    ...
    AddTimeSheetComponent.prototype.savetimeSheet = function (status) {
        var _this = this;
        ...
        if (this.gemsTimeSheetDetailId != null || this.gemsTimeSheetDetailId != undefined) {
            ...
            for (var hourIndex = 0; hourIndex < 7; hourIndex++) {
        ...
        var stringToSplit = this.newtimesheet.value.week;
        ...
        this.genericservice.post(this.saveTimeSheetApi, this.timeSheetWrapper, '').subscribe(function (timeSheetData) {
            if (timeSheetData.data != null) {
                _this.router.navigateByUrl('/user/timesheet');
            }
        });
    ...
    AddTimeSheetComponent.prototype.onChange = function (newValue) {
        console.log(newValue);
        this.selectedproject = newValue;
    };
    AddTimeSheetComponent.prototype.getCSSClasses = function (flag) {
        var cssClasses;
...
var EditTimeSheetComponent = /** @class */ (function () {
    function EditTimeSheetComponent(genericservice, encryptdecryptlocalstorage) {
        this.genericservice = genericservice;
        this.encryptdecryptlocalstorage = encryptdecryptlocalstorage;
    ...
    EditTimeSheetComponent.prototype.getAssignedProjectList = function () {
        var _this = this;
        var payLoad = {
            "gemsEmployeeMaster": {
                "gemsEmployeeMasterId": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
        ...
        this.genericservice.post(this.getProjectListApi, payLoad, '').subscribe(function (response) {
            _this.projectList = response.data;
            _this.selectedproject = _this.projectList != null ? _this.projectList[0] : null;
...
var TimeSheetComponent = /** @class */ (function () {
    function TimeSheetComponent(router, genericservice, encryptdecryptlocalstorage, loadingBar) {
        this.router = router;
        this.genericservice = genericservice;
        this.encryptdecryptlocalstorage = encryptdecryptlocalstorage;
    ...
    TimeSheetComponent.prototype.onChange = function (newValue) {
        this.selectedproject = newValue;
        this.getTimeSheetdetail(this.selectedproject);
    };
    TimeSheetComponent.prototype.getAssignedProjectList = function () {
        var _this = this;
        var payLoad = {
            "gemsEmployeeMaster": {
                "gemsEmployeeMasterId": this.encryptdecryptlocalstorage.getLocalStorage('employeeId'),
        ...
        this.genericservice.post(this.getProjectListApi, payLoad, '').subscribe(function (response) {
            _this.projectList = response.data;
            _this.selectedproject = _this.projectList != null ? _this.projectList[0].gemsProjectMaster : null;
            _this.projectList != null ? _this.getTimeSheetdetail(_this.projectList[0].gemsProjectMaster) : null;
        });
    };
    TimeSheetComponent.prototype.getTimeSheetdetail = function (projectData) {
        var _this = this;
        var payLoad = {
            "createdBy": {
                "gemsEmployeeMasterId": this.encryptdecryptlocalstorage.getLocalStorage('employeeId')
        ...
        this.genericservice.post(this.getTimeSheetListApi, payLoad, '').subscribe(function (response) {
            _this.timeSheetList = response.data;
        });
    };
    TimeSheetComponent.prototype.clickedOnEditTimeSheet = function (timesheetdetail) {
...
/* harmony import */ var _ngx_loading_bar_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ngx-loading-bar/core */ "./node_modules/@ngx-loading-bar/core/fesm5/ngx-loading-bar-core.js");
...
//# sourceMappingURL=time-sheet-time-sheet-module-ngfactory-es5.js.map